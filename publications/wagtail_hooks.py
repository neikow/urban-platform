...
def register_vote_stats_url():
    return [
        path("vote-statistics/", VoteStatsView.as_view(), name="vote_statistics"),
        path("vote-statistics/<int:project_id>/", VoteStatsDetailView.as_view(), name="vote_statistics_detail"),
    ]


@hooks.register("register_admin_menu_item")
def register_vote_stats_menu_item():
    return MenuItem(
        _("Vote Statistics"),
